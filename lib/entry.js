...
dodgercms.entry = (function() {
  ...
  var SITE_PATH = localStorage.getItem('dodgercms-site-path');
        ...
        function buildFromSegments(scope, parentScope, keyParts, pathSegments, isFolder, keyLabel) {
          ...
          if (!found) {
            ...
            found = {
              ...
              link: (isFolder) ? null : (SITE_PATH === '') ? '/' + key : SITE_PATH + '/' + key,
              label: label,
              children: false
            };
            ...
            if (parentScope && current === 'index') {
              parentScope.link = (SITE_PATH === '') ? '/' + parentScope.key : SITE_PATH + '/' + parentScope.key;
            }
