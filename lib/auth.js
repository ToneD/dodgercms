...
dodgercms.auth = (function() {
  ...
  */
  var getCredentials = function(allOrNothing) {
    var credentials = {
      ...
      assetsPath: localStorage.getItem('dodgercms-assets-path'),
      sitePath: localStorage.getItem('dodgercms-site-path'),
    ...
    sts.getFederationToken(stsParams, function(err, data) {
      if (err) {
        ...
        var s3 = new AWS.S3({
          ...
          sslEnabled: true,
          endpoint: 's3-' + params.region + '.amazonaws.com'
        });
          ...
          if (err) {
            ...
            function(err, results) {
              if (err) {
                ...
                localStorage.setItem('dodgercms-assets-path', params.assetsPath);
                localStorage.setItem('dodgercms-site-path', params.sitePath);
  ...
  */
  function logout() {
    ...
    localStorage.removeItem('dodgercms-region');
    ...
    localStorage.removeItem('dodgercms-assets-path');
    localStorage.removeItem('dodgercms-site-path');
